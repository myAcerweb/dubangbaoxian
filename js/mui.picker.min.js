 ...
 * Houfeng@DCloud.io
 **/
var win = window;dpr = win.devicePixelRatio || 1;var scale = 1 / dpr;
! function(e, t, i, n) {
	var a = 30,
		r = 90,
		s = 40,
	...
	p.prototype.findElementItems = function() {
		...
		e && (t.items = []), t.elementItems.forEach(function(i) {
			...
			if(t.endAngle = t.itemAngle * n, i.angle = t.endAngle, i.style.webkitTransformOrigin = "center center -" + t.r * 2 + "px", i.style.webkitTransform = "translateZ(" + t.r * 2 + "px) rotateX(" + -t.endAngle + "deg)", e) {
				var a = {};
